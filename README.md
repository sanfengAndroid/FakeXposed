...
5. For some simulators (such as Raiden), when the application contains both `arm` and `x86` architectures, the `arm` architecture is preferred and the software crashes. You can download the `x86` version. 
