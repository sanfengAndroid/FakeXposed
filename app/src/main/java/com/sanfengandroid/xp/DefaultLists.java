...
public class DefaultLists {
    ...
    public static final String[] DEFAULT_KEYWORD_LIST = {"supersu", "magisk", "magisk32", "magisk64", "magiskhide", "magiskinit", "superuser", "Superuser", "noshufou", "xposed", "rootcloak", "chainfire", "titanium", "Titanium", "substrate", "greenify", "daemonsu", "root", "busybox", "titanium", ".tmpsu", "su", "rootcloak2"};
    ...
    static {
        ...
        DEFAULT_RUNTIME_LIST = new Pair[]{new Pair<>(rbean.oldCmd, list), new Pair(which.oldCmd, whichs)};
    }
}
